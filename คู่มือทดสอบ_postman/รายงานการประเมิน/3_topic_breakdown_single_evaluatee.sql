...
-- 3_topic_breakdown_single_evaluatee.sql
-- Purpose: Show per-topic rate & contribution to 60 for a single evaluatee and period (MySQL 5.7+ compatible).
-- Params to replace: :period_id, :evaluatee_id
SELECT
  t.id AS topic_id,
